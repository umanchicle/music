...
public class F7b5 extends Major implements IFuncion {
	...
	private F7b5() {
		...
		funcion.add(FuncionEnum.majMen7b5);
	}
	
	public F7b5(NotaEnum tonalidad) {
	...
	public F7b5(NotaEnum tonalidad, int type) {
