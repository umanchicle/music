...
public class F7sus4Sos5 extends Major implements IFuncion {
	...
	private F7sus4Sos5() {
		...
		funcion.add(FuncionEnum.majMen7sus4Sos5);
	}
	
	public F7sus4Sos5(NotaEnum tonalidad) {
	...
	public F7sus4Sos5(NotaEnum tonalidad, int type) {
	...
	public static void main(String[] args) {
		...
		F7sus4Sos5 f = new F7sus4Sos5(NotaEnum.C);
