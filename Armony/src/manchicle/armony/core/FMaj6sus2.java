...
public class FMaj6sus2 extends Major implements IFuncion {
	...
	private FMaj6sus2() {
		...
		funcion.add(FuncionEnum.maj6sus2);
	}
	
	public FMaj6sus2(NotaEnum tonalidad) {
	...
	public FMaj6sus2(NotaEnum tonalidad, int type) {
	...
	public static void main(String[] args) {
		...
		FMaj6sus2 f = new FMaj6sus2(NotaEnum.C);
