...
public class FMaj6sus2b5 extends Major implements IFuncion {
	...
	private FMaj6sus2b5() {
		...
		funcion.add(FuncionEnum.maj6sus2b5);
	}
	
	public FMaj6sus2b5(NotaEnum tonalidad) {
	...
	public FMaj6sus2b5(NotaEnum tonalidad, int type) {
	...
	public static void main(String[] args) {
		...
		FMaj6sus2b5 f = new FMaj6sus2b5(NotaEnum.C);
