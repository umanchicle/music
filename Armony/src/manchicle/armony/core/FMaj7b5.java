...
public class FMaj7b5 extends Major implements IFuncion {
	...
	private FMaj7b5() {
		...
		funcion.add(FuncionEnum.maj7b5);
	}
	
	public FMaj7b5(NotaEnum tonalidad) {
	...
	public FMaj7b5(NotaEnum tonalidad, int type) {
	...
	public static void main(String[] args) {
		...
		FMaj7b5 f = new FMaj7b5(NotaEnum.C);
