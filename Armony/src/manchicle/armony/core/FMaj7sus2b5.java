...
public class FMaj7sus2b5 extends Major implements IFuncion {
	...
	private FMaj7sus2b5() {
		...
		funcion.add(FuncionEnum.maj7sus2b5);
	}
	
	public FMaj7sus2b5(NotaEnum tonalidad) {
	...
	public FMaj7sus2b5(NotaEnum tonalidad, int type) {
	...
	public static void main(String[] args) {
		...
		FMaj7sus2b5 f = new FMaj7sus2b5(NotaEnum.C);
