...
public class FMen7Sos5 extends Menor implements IFuncion {
	...
	private FMen7Sos5() {
		...
		funcion.add(FuncionEnum.men7Sos5);
	}
	
	public FMen7Sos5(NotaEnum tonalidad) {
	...
	public FMen7Sos5(NotaEnum tonalidad, int type) {
	...
	public static void main(String[] args) {
		...
		FMen7Sos5 f = new FMen7Sos5(NotaEnum.C);
