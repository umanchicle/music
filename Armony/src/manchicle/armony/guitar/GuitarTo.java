...
public class GuitarTo {
	...
	Map<EspacioEnum, PosturaTo[]> estructura = new HashMap<EspacioEnum, PosturaTo[]>();
	...
	public Map<EspacioEnum, PosturaTo[]> getEstructura() {
		return estructura;
	}
	
	public void addEstructura(EspacioEnum espacio, PosturaTo[] postura) {
